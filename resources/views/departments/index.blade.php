    ...
    <div class="row">
        <div class="card mx-auto">
            ...
            <div class="card-header">
                <form action="{{ route('departments.index') }}" method="get" class="d-inline">
                                ...
                                <td>
                                    ...
                                    @can('delete department')
                                        ...
                                        <button type="button" class="btn btn-danger deletebtn" data-toggle="modal"
                                            data-target="#DeleteModal" data-department_id="{{ $department->id }}">
                                            Delete
                                        </button>
                                    @endcan
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal_body">
                        <form action="{{ url('departments/destroy') }}" method="post" class="deleteForm">
                            @csrf
                            @method('DELETE')
...
<script>
    window.onclick = function(event) {
        if (event.target.hasAttribute('data-department_id')) {

            var element = event.target;
            var departmentID = element.getAttribute('data-department_id');
